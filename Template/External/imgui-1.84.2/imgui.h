...
struct ImGuiStyle
{
    ...
    bool        AntiAliasedLinesUseTex;     // Enable anti-aliased lines/borders using mTextures where possible. Require backend to render with bilinear filtering. Latched at the beginning of the frame (copied to ImDrawList).
...
enum ImDrawListFlags_
{
    ...
    ImDrawListFlags_AntiAliasedLinesUseTex  = 1 << 1,  // Enable anti-aliased lines/borders using mTextures when possible. Require backend to render with bilinear filtering.
...
enum ImFontAtlasFlags_
{
    ...
    ImFontAtlasFlags_NoBakedLines       = 1 << 2    // Don't build thick line mTextures into the atlas (save a little texture memory). The AntiAliasedLinesUseTex features uses them, otherwise they will be rendered using polygons (more expensive for CPU/GPU).
};
